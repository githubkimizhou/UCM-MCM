...
/**
 * struct avs_codec_audio_param - The parameters to set audio codec to AVS.
 *
...
/**
 * struct avs_codec_video_param - The parameters to set video codec to AVS.
 *
...
/**
 * avs_set_audio_codec_param - Set the parameters of audio codec.
 * @param:  The parameters to set audio codec to AVS.
 * @resp:  The response informations returned from AVS.
 *
 * Return: AVS_CMD_RESULT.
 */
...
/**
 * avs_set_video_codec_param - Set the parameters of video codec.
 * @param:  The parameters to set video codec to AVS.
 * @resp:  The response informations returned from AVS.
 *
 * Return: AVS_CMD_RESULT.
 */
